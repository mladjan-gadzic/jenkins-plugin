...
import random.pod.retention.PodRetention;
import random.pod.yaml.YamlMergeStrategy;
...
public class PodTemplate extends AbstractDescribableImpl<PodTemplate> implements Serializable, Saveable {
    ...
    public String getRemoteFs() {
        return getFirstContainer().map(ContainerTemplate::getWorkingDir).orElse(
    ...
    protected Object readResolve() {
        if (containers == null) {
            ...
            ContainerTemplate containerTemplate = new ContainerTemplate(
                ArmadaCloud.JNLP_NAME, this.image);
    ...
    public static class DescriptorImpl extends Descriptor<PodTemplate> {
        ...
        public List<? extends Descriptor> getEnvVarsDescriptors() {
            return DescriptorVisibilityFilter.apply(null, Jenkins.get().getDescriptorList(
                TemplateEnvVar.class));
        }
