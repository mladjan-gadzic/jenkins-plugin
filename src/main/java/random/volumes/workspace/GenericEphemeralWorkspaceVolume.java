package random.volumes.workspace;
...
import random.volumes.EphemeralVolume;
import random.volumes.PVCVolumeUtils;
...
public class GenericEphemeralWorkspaceVolume extends
    WorkspaceVolume implements EphemeralVolume {
