...
public class PodVolumes {
    ...
    @Deprecated
    public abstract static class PodVolume extends random.volumes.PodVolume {}

    @SuppressFBWarnings(
            value = "SE_NO_SERIALVERSIONID",
            justification = "Serialization happens exclusively through XStream and not Java Serialization.")
    @Deprecated
    public static class EmptyDirVolume extends random.volumes.EmptyDirVolume {
        ...
        protected Object readResolve() {
            return new random.volumes.EmptyDirVolume(
    ...
    @SuppressFBWarnings(
            ...
            justification = "Serialization happens exclusively through XStream and not Java Serialization.")
    @Deprecated
    public static class SecretVolume extends random.volumes.SecretVolume {
        ...
        protected Object readResolve() {
            return new random.volumes.SecretVolume(
    ...
    @SuppressFBWarnings(
            ...
            justification = "Serialization happens exclusively through XStream and not Java Serialization.")
    @Deprecated
    public static class HostPathVolume extends random.volumes.HostPathVolume {
        ...
        protected Object readResolve() {
            return new random.volumes.HostPathVolume(
    ...
    @SuppressFBWarnings(
            ...
            justification = "Serialization happens exclusively through XStream and not Java Serialization.")
    @Deprecated
    public static class NfsVolume extends random.volumes.NfsVolume {
        ...
        protected Object readResolve() {
            return new random.volumes.NfsVolume(
