...
import static random.KubernetesFactoryAdapter.resolveCredentials;
...
import random.pipeline.PodTemplateMap;
import random.pod.retention.Default;
...
public class ArmadaCloud extends Cloud implements PodTemplateGroup {
    ...
    public Collection<NodeProvisioner.PlannedNode> provision(
            @NonNull final CloudState state, final int excessWorkload) {
